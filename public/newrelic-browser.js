...
NREUM.loader_config = {
  ...
  trustKey: "4870376",
  agentID: "601507961",
  licenseKey: "NRJS-cc6d3c2ba3c39f6be79",
  applicationID: "601507961",
};
NREUM.info = {
            ...
            void 0 === e.api &&
              (e.api = (function (e, t, h = !1) {
                ...
                (p.log = function (
                  ...
                  (0, a.p)(f.xV, ["API/log/called"], void 0, n.K.metrics, x),
                    (0, w.R)(x, e, t, r);
                }),
                  (p.wrapLogger = (
                    e,
    ...
    (i.l = (r, n, o, a) => {
      if (e[r]) e[r].push(n);
        ...
        if (!s) {
          c = !0;
          var f = {
            478: "sha512-BDnQSqs6w93jZNuA2+ydjStO6iZUcCDM2G5ACNl42PnZebXqSDjfzp21rEmyIS/uS1Mm/KhHBftMozfaupNTFQ==",
            249: "sha512-+3RM3jpjuKfYqtWclSvdJHGFcW1Zs3W91YF6LLj05mh2KF2Dd4d/UbOS+Gj8JJIB3+OhK9x9MEoWBx6J1Qp+Hw==",
            212: "sha512-2D6xSed7GvSJDbO/jQCNsTNZTswnT4nkZPDOuerj6rroMh2F2IQsO5rZkHWXh31IDaiIxoiUn44tUfBomWqChw==",
          };
    ...
    (() => {
          ...
          const n = async () => {
            ...
            try {
              if (!this.#t(this.featureName, n))
                return (
                  (0, d.Ze)(this.agentIdentifier, this.featureName), void r(!1)
                );
          ...
          se(this.ee),
            ...
            (function (e, t, r, n) {
              ...
              function c(e, r) {
                ...
                for (var s = 0; s < he; s++)
                  r.addEventListener(fe[s], this.listener, (0, N.jT)(!1));
              }
              function u(e, t, r) {
                (this.cbTime += e),
              ...
              function x(e) {
                ...
                if (!this.ended) {
                  this.ended = !0;
                  for (let t = 0; t < he; t++)
                    e.removeEventListener(fe[t], this.listener, !1);
                  t.aborted ||
                    (0, le.iW)(t) ||
      ...
      function we(e) {
        ...
        return (
          !h.RI ||
            be[t.debugId]++ ||
            ((be[t.debugId] = 1),
            (0, Y.YM)(t).inPlace(window.history, ye, "-")),
          t
        );
      }
      var xe = i(3738);
        ...
        constructor(e, t, r = !0) {
          ...
          we(n),
            ...
            this.eventsEE.on(Ne, function (e, t) {
              (0,
              E.p)("bst", [e[0], t, this.bstStart, (0, I.t)()], void 0, o.K.sessionTrace, n);
            }),
      ...
      class Pe extends v {
        ...
        constructor(e, r, n = !0) {
          ...
          try {
            i = JSON.parse(
              localStorage.getItem("".concat(je.H3, "_").concat(je.uh))
            );
          } catch (e) {}
          (0, g.SR)(e) && this.ee.on(t.G4.RECORD, () => this.#o()),
            this.#a(i)
              ? ((this.#i = i?.sessionReplayMode), this.#s())
              : this.importAggregator(),
            this.ee.on("err", (e) => {
              this.replayRunning &&
                ((this.errorNoticed = !0),
        ...
        #a(e) {
          return (
            (e &&
              (e.sessionReplayMode === je.g.FULL ||
                e.sessionReplayMode === je.g.ERROR)) ||
        ...
        #o() {
          this.featAggregate
            ? this.featAggregate.mode !== je.g.FULL &&
              this.featAggregate.initializeRecording(je.g.FULL, !0)
            : ((this.#i = je.g.FULL),
              this.#s(t.Qb.API),
              this.recorder &&
      ...
      class at extends v {
        ...
        constructor(e, t, r = !0) {
          ...
          this.ee.on(nt, m),
            ...
            c.buffer(
              ["setTimeout" + Qe, "clearTimeout" + Je, nt],
              this.featureName
            ),
            u.buffer([nt, "new-xhr", "send-xhr" + Je], this.featureName),
            l.buffer(
              [rt + Je, rt + "-done", rt + $e + Je, rt + $e + Qe],
              this.featureName
            ),
            f.buffer(["newURL"], this.featureName),
            g.buffer([nt], this.featureName),
            s.buffer(
              ["propagate", it, et, "executor-err", "resolve" + Je],
              this.featureName
            ),
        ...
        constructor(e, t, r = !0) {
          ...
          h.RI &&
            ...
            (st.Zp.forEach((e) =>
              (0, N.sp)(
                e,
                (e) => (0, E.p)("ua", [e], void 0, this.featureName, this.ee),
                !0
              )
            ),
            st.qN.forEach((e) =>
              (0, N.sp)(e, (e) =>
                (0, E.p)("ua", [e], void 0, this.featureName, this.ee)
              )
            )),
            i.some((e) => e)
              ? this.importAggregator()
      ...
      new (class extends n {
        ...
        features: [me, y, _, _e, Pe, P, U, ct, lt, ke, at],
        loaderType: "spa",
      });
    })();
})();
